...
import uk.co.q3c.v7.base.navigate.sitemap.impl.AbstractNode;
import uk.co.q3c.v7.base.navigate.sitemap.impl.NavigationStateImpl;
import uk.co.q3c.v7.base.navigate.sitemap.impl.ParametersImpl;
...
public class DefaultSitemap implements Sitemap {
	...
	public class ViewNode extends AbstractNode {
		...
		private final Class<? extends V7View> view;

		public ViewNode(String uri, Class<? extends V7View> view) {
			super(uri);
			this.view = view;
		}
	...
	private HashMap<Class<? extends V7View>, AbstractNode> nodesByClass = new HashMap<>();
	...
	@Override
	public ViewNode addView(String uri, Class<? extends V7View> view) {
	...
	private void checkUniqueClass(Class<? extends V7View> view) {
	...
	private AbstractNode get(Class<? extends V7View> viewClass) {
	...
	public NavigationState buildNavigationState(
			Class<? extends V7View> viewClass) throws PageNotFoundException {
